...
URL_PATTERN = re.compile(
    r"^https?://(stockn\.xueqiu\.com|[\w.-]*10jqka\.com\.cn|static\.cninfo\.com\.cn|www1?\.hkexnews\.hk)/.+\.(pdf|PDF)$",
    re.IGNORECASE,
)
...
def parse_args(argv=None):
    ...
    parser.add_argument(
        "--save-dir", default="./report", help="Directory to save the PDF (default: ./report)"
    )
    parser.add_argument(
        "--max-retries",
        type=int,
